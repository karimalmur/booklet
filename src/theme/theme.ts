...
export const getDesignTokens = (mode: 'light' | 'dark') =>
  ({
    ...
    shadows: [
      'none',
      '0 0 transparent, 0 0 transparent, 0 1px 2px 0 rgba(0,0,0,0.1)',
    ...
    components: {
      ...
      MuiDivider: {
        styleOverrides: {
          root: {
            borderColor:
              theme.palette.mode === 'dark' ? alpha(theme.palette.primary[100], 0.08) : theme.palette.grey[100],
          },
        },
      },
      MuiLink: {
          ...
          root: ({ ownerState: { color, variant } }) => ({
            ...
            ...(variant === 'light' && {
              ...
              ...(color === 'warning' && {
                ...
                backgroundColor:
                  theme.palette.mode === 'dark' ? theme.palette.warning[900] : theme.palette.warning[100],
              }),
              ...(color === 'success' && {
                color: theme.palette.mode === 'dark' ? '#fff' : theme.palette.success[900],
                backgroundColor:
                  theme.palette.mode === 'dark' ? theme.palette.success[900] : theme.palette.success[100],
              }),
            }),
          }),
          deleteIcon: {
